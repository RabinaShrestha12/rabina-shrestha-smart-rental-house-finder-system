# Generated by Django 5.0 on 2026-01-24 06:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('admin', 'Admin'), ('owner', 'Owner'), ('tenant', 'Tenant')], default='tenant', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('room', 'Room'), ('house', 'House'), ('apartment', 'Apartment')], default='room', max_length=20)),
                ('price_per_week', models.DecimalField(decimal_places=2, max_digits=10)),
                ('location', models.CharField(max_length=255)),
                ('owner_contact_number', models.CharField(blank=True, max_length=30)),
                ('owner_contact_email', models.EmailField(blank=True, max_length=254)),
